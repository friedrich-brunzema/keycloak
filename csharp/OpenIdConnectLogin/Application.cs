...
namespace gt
{
  internal class Application
  {
    ...
    private const string KeyCloakUrlVerification = "https://login.qa.oneomics.net/auth/";
    private const string KeyCloakUrlBeta = "https://login.beta.sciex.com/auth/";

    private const string KeyCloakVerificationBaseAddress = "https://login.qa.oneomics.net";
    ...
    {
      var request = new RestRequest("https://login.qa.oneomics.net/auth", Method.POST);
      var httpClientHandler = new HttpClientHandler
      {
        AllowAutoRedirect = false,
        AutomaticDecompression = DecompressionMethods.GZip | DecompressionMethods.Deflate
